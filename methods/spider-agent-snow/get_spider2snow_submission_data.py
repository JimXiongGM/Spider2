    ...
    for instance_id in os.listdir(output_dir):
        ...
        if answer_or_path == "":
            results_metadata.append(
                {"instance_id": instance_id, "answer_or_path": "", "answer_type": "answer"}
            )
            continue
        elif os.path.exists(os.path.join(result_folder_root_path, answer_or_path)):
            results_metadata.append(
                {"instance_id": instance_id, "answer_or_path": answer_or_path, "answer_type": "file"}
            )
            try:
                copy_folder(
            ...
            results_metadata.append(
                {"instance_id": instance_id, "answer_or_path": answer_or_path, "answer_type": "answer"}
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--results_folder_name",
        type=str,
        default="../../spider2/evaluation_suite/gpt-4-try1",
