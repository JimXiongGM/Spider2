...
def call_llm(payload):
    ...
    if model.startswith("gpt"):
        ...
        for i, message in enumerate(messages):
            o1_message = {"role": message["role"] if message["role"] != "system" else "user", "content": ""}
        ...
        for i, message in enumerate(messages):
            gemini_message = {"role": message["role"], "content": []}
    ...
    #     return False, code_value
        ...
        for i, message in enumerate(messages):
            deepseek_message = {"role": message["role"], "content": ""}
            for part in message["content"]:
